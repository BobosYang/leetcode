package com.leetcode.y2022.m06;
...
public class Jun04 {
	...
	public int numUniqueEmails(String[] emails) {
		...
		Set<String> finalEmails = new HashSet<String>();
...
//			System.out.println(localName);
//			System.out.printf("originEmail=%s\nfinalEmail=%s\n", email, localName + "@" + domainName);
			finalEmails.add(localName + "@" + domainName);
		}
